...
I, RJRico17, understand that AI is ONLY to be used for tests, and that every commit that I use AI for must start with 'AI Used'

I, SketchRudy, understand that AI is ONLY to be used for tests, and that every commit that I use AI for ust start with 'AI Used"
